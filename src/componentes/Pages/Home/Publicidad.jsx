...
export default function Publicidad({ isLoggedIn }) {
  ...
  return (
    <div>
      {!isLoggedIn ? (
        <div className="mx-auto mt-24 mb-24 bg-slate-200 w-[350px] base:w-[768px] md:w-[1024px] lg:w-[1400px] xl:w-[1800px] h-[200px] md:h-[400px] flex justify-around text-center">
          <h1
