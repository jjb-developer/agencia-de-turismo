...
export default function Main({ servicios }) {
  ...
  return (
    <div className="container h-[600px] mx-auto grid place-items-center bg-cover bg-center relative overflow-hidden">
      <div
      ...
      >
        <div
          className={`content absolute top-[10%] left-12 font-roboto font-bold text-base shadow-lg
           shadow-black w-[400px] h-[400px] bg-slate-600 text-black p-4 opacity-80 rounded-xl ${
            animateShow ? "animate-show" : ""
          }`}
        >
          <div className="w-[350px] h-[300px] bg-slate-400 rounded-lg shadow-lg shadow-black mx-auto">
        ...
        <div className="secondary-images mb-4 w-100% opacity-90 flex-shrink-0 flex justify-center pr-12 absolute bottom-8 right-0 transform translate-x-[calc(-100% + 20px)] -translate-y-1/2 z-[1] select-none duration-300 ">
