...
export default function AgregarServicio() {
	...
	return (
		<>
		<Navbar/>
		<main className="bg-zinc-200 py-10 pt-48">
			<div className='mx-auto p-10 bg-zinc-50 max-w-[500px]'>
				<h4 className='mb-7 pb-10 text-2xl font-medium tracking-tight capitalize max-w-[500px] mx-auto text-zinc-800 border-b-2'>Agregar Servicios</h4>
				<form 
